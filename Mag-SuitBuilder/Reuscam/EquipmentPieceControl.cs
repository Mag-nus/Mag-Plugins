...
namespace Mag_SuitBuilder
{
	partial class EquipmentPieceControl : UserControl, IEquipmentPiece
	{
        ...
        private Constants.EquippableSlotFlags mEquipableSlots;
		public Constants.EquippableSlotFlags EquipableSlots {
            get
            {
                return mEquipableSlots;
            }

            set
            {
                mEquipableSlots = value;
                ...
                toolTip1.SetToolTip(this.chkLocked, this.EquipableSlots.ToString());
            }
        }
