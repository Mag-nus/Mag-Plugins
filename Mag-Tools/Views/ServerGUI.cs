	...
	class ServerGUI
	{
		...
		void LoginAdd_Hit(object sender, EventArgs e)
		{
			try
			{
				...
				var commands = Settings.SettingsManager.Server.GetOnLoginCommands(CoreManager.Current.CharacterFilter.Server);

				commands.Add(command);

				Settings.SettingsManager.Server.SetOnLoginCommands(CoreManager.Current.CharacterFilter.Server, commands);
		...
		void PeriodicCommandAdd_Hit(object sender, EventArgs e)
		{
			try
			{
				...
				var commands = Settings.SettingsManager.Server.GetPeriodicCommands(CoreManager.Current.CharacterFilter.Server);
				...
				Settings.SettingsManager.Server.SetPeriodicCommands(CoreManager.Current.CharacterFilter.Server, commands);
