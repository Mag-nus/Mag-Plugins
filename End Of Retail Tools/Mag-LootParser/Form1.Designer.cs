namespace Mag_LootParser
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
			...
			this.chkGeneratecontainersLootJson = new System.Windows.Forms.CheckBox();
			...
			// tabPage1
			// 
			this.tabPage1.Controls.Add(this.chkGeneratecontainersLootJson);
			...
			// 
			// chkGeneratecontainersLootJson
			// 
			this.chkGeneratecontainersLootJson.AutoSize = true;
			this.chkGeneratecontainersLootJson.Location = new System.Drawing.Point(65, 128);
			this.chkGeneratecontainersLootJson.Name = "chkGeneratecontainersLootJson";
			this.chkGeneratecontainersLootJson.Size = new System.Drawing.Size(165, 17);
			this.chkGeneratecontainersLootJson.TabIndex = 15;
			this.chkGeneratecontainersLootJson.Text = "Generate containersLoot json";
			this.chkGeneratecontainersLootJson.UseVisualStyleBackColor = true;
			// 
			// Form1
			// 
		...
		private System.Windows.Forms.CheckBox chkGeneratecontainersLootJson;
	}
}
